...
- Fully open source
- Better interface for viewing historical seasons
...
- NALTP S30-37: minor data cleaning
- NALTP S10-29: major data cleaning + actually import it all to the site + add playoff games
...
If you want to help the TagPro Reference project, the main way you can contribute is by **cleaning historical data**. Either by directly fixing mistakes in historical data or by collecting historical data from non-NALTP seasons. If you would like to help clean data, please message me and I will help you get started.
