...
urlpatterns = [
    ...
    path('league/<str:league_abbr>/', views.league_history_by_abbr, name='league_history_by_abbr'),
    ...
    path('season/<str:season_name>/', views.season_home_by_name, name='season_home_by_name'),
    path('season/<str:season_name>/schedule/', views.season_schedule_by_name, name='season_schedule_by_name'),
    path('season/<str:season_name>/stats/', views.season_stats_by_name, name='season_stats_by_name'),
    path('season/<str:season_name>/rosters/', views.season_rosters_by_name, name='season_rosters_by_name'),
    ...
    path('edit/season/<str:season_name>/', views.edit_season_by_name, name='edit_season_by_name'),
]